...
const Services = () => {
  return (
    <div>
      ...
      <section class=" py-12 sm:py-16 lg:py-20 bg-[#f7dbc0]">
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
          <div class="sm:text-center">
            <h2 class="text-3xl font-medium leading-7 text-green-800 sm:text-4xl xl:text-5xl">
              What We <br class="sm:hidden" />
              Offer
            </h2>
            <hr class="mt-4 h-1 w-32 border-none bg-green-600 sm:mx-auto sm:mt-8" />
          </div>

          <div class="mt-20 grid grid-cols-1 gap-x-8 gap-y-12 text-green-800 text-center sm:grid-cols-3 sm:text-left lg:gap-0 max-w-screen-xl mx-auto">
      ...
      <section class="relative bg-[#f7dbc0] py-10 text-green-900 sm:py-16 lg:py-24">
        <div className=" mb-36">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="text-center">
            <div class="mb-4 inline-flex h-12 w-12 text-green-800">
              <svg
                viewBox="0 0 136 217"
                fill="none"
            ...
            <div class="sm mt-8 flex flex-col items-center justify-center sm:flex-row sm:space-x-4 sm:px-0 lg:mt-12">
              <button class="mt-4 rounded-lg border-2 border-green-800 bg-green-600 px-6 py-2 font-medium text-white transition hover:translate-y-1">
                Try Now
              </button>
              {/* <button class="mt-4 rounded-lg border-2 border-green-800 px-6 py-2 font-medium text-green-800 transition hover:translate-y-1">
                Choose a Plan
              </button> */}
            </div>
            ...
            <p class="mt-6 text-base ">
              ...
              <Link
                to="/"
                class="text-green-600 transition-all duration-200 hover:text-green-800 hover:underline focus:text-green-800"
              >
                Log in
              </Link>
            </p>
