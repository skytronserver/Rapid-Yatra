        ...
        <div className="mx-auto mb-20 flex w-full max-w-screen-lg flex-col overflow-hidden rounded-xl text-gray-700 md:flex-row md:border md:shadow-lg bg-white">
          <form className="mx-auto w-full max-w-xl border-gray-200 px-10 py-8 md:px-8">
            <div className="mb-4">
              ...
              <input
                ...
                }  px-3 py-2 outline-none ring-blue-500 focus:ring rounded-lg`}
                id="email"
                type="email"
                required=""
                value={email}
            ...
            <div className="mb-4">
              ...
              <input
                className={`w-full rounded border ${
                  subjectError ? "border-red-600" : "border-gray-300"
                }  px-3 py-2 outline-none ring-blue-500 focus:ring rounded-lg`}
                id="subject"
                type="subject"
                required=""
          ...
          <div className="mt-10 bg-blue-600 px-10 py-8 text-gray-100 md:mt-0 md:ml-auto">
            <div className="">
              ...
              <p className="mb-1">PreciTrack Mapwala Private Limited</p>
              <p className="mb-1">2, Civil Lines Enclave, Civil Lines</p>
              <p className="mb-4">Gurgaon 122001</p>
