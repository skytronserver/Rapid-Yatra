...
const Contact = () => {
  return (
    <div>
      <Navbar page={"contact"} />
      <div class="font-sans text-base text-green-900 sm:px-10 bg-[#f7dbc0] pb-14">
        ...
        <div class="mx-auto mb-20 flex w-full max-w-screen-lg flex-col overflow-hidden rounded-xl text-green-900 md:flex-row md:border md:shadow-lg bg-white">
          <form class="mx-auto w-full max-w-xl border-gray-200 px-10 py-8 md:px-8">
            <div class="mb-4">
              ...
              <input
                class="w-full rounded border border-gray-300 px-3 py-2 outline-none ring-green-500 focus:ring"
                id="email"
                type="email"
                required=""
              />
            ...
            <div class="mb-4">
              ...
              <textarea
                class="h-52 w-full rounded border border-gray-300 px-3 py-2 outline-none ring-green-500 focus:ring"
                id="message"
                required=""
              ></textarea>
            </div>
            <div class="flex items-center">
              ...
              <button
                class="rounded-xl bg-green-600 px-4 py-3 text-center font-bold text-white hover:bg-green-700"
                type="submit"
              >
                Send message
              </button>
          ...
          <div class="mt-10 bg-green-600 px-10 py-8 text-gray-100 md:mt-0 md:ml-auto">
