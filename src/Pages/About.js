          ...
          <div className="mx-auto max-w-screen-xl px-4 md:px-8 mb-20 ">
            <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
              <div className="md:pt-8 lg:flex lg:flex-col lg:justify-center">
                ...
                <h1 className="mb-4 text-center text-2xl font-bold text-blue-800 sm:text-3xl md:mb-6 md:text-left">
              ...
              <div className="md:col-span-2">
                <h2 className="mb-2 text-center text-xl font-semibold text-blue-800 sm:text-2xl md:mb-4 md:text-left">
                  About us
                </h2>
