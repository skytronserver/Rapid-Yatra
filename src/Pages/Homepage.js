            ...
            <div className="relative flex-grow flex items-center justify-center px-4 py-16 sm:py-24">
                <div className="text-center max-w-4xl">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mb-8">
                        <Link
                            to="/services"
                            className="group px-3 sm:px-8 py-2 sm:py-4 bg-gradient-to-r from-indigo-600 to-cyan-600 text-white rounded-lg sm:rounded-2xl font-semibold hover:shadow-2xl hover:shadow-indigo-500/25 transition-all duration-300 hover:scale-105 relative overflow-hidden text-sm sm:text-base"
                        >
                        ...
                        <Link
                            to="/login"
                            className="group px-3 sm:px-8 py-2 sm:py-4 bg-white/70 backdrop-blur-sm border-2 border-cyan-600 text-cyan-600 rounded-lg sm:rounded-2xl font-semibold hover:bg-cyan-50 hover:shadow-xl transition-all duration-300 hover:scale-105 text-sm sm:text-base"
                        >
